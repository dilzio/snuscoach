...
Last updated: 2026-05-13 · Current branch: `feature/wins-posts-ui`
...
| Wins & Posts section: wins ledger + post history + AI drafting chat + save post | ✅ | `feature/wins-posts-ui`; wins ledger with selection + inject + "✓ posted" badge, post history with View/Edit expand dialog and "Open in chat →" per-post thread, per-win/per-post contextual chat with persistent threads, Save Post records win_id; 43 Playwright tests |
